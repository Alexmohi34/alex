...
if (isset($_GET['action']) && $_GET['action'] == 'EDIT') {//در صورت کلیک روی پیوند ویرایش 
    $id = $_GET['id'];
    $query = "SELECT * FROM products WHERE pro_code='$id'";
    $result = mysqli_query($link, $query);
    if ($row = mysqli_fetch_array($result)) {//دریافت مشخصات محصول انتخاب شده برای ویرایش و نمایش مشخصات در کادرهای متن
...
?>
  ...
  <br />
  <!-- دستورات ایجاد نمون برگ دریافت مشخصات محصولات فروشگاه -->
...
<?php
//ایجاد پرس و جوی نمایش محصولات
$query = "SELECT * FROM products";
$result = mysqli_query($link, $query);

?>
<!-- سر ستون جدول محصولات -->
